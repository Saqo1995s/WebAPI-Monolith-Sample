...
namespace IUniversity.Core.Migrations
{
    ...
    [Migration("20220310200949_StudentAndTeacherEntitiesFixed")]
    partial class StudentAndTeacherEntitiesFixed
    {
            ...
            modelBuilder.Entity("IUniversity.Common.Entities.Student", b =>
                {
                    b.HasOne("IUniversity.Common.Entities.Account", "StudentAccount")
                        ...
                        .HasForeignKey("IUniversity.Common.Entities.Student", "StudentAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IUniversity.Common.Entities.Teacher", b =>
                {
                    b.HasOne("IUniversity.Common.Entities.Account", "TeacherAccount")
                        .WithOne("AccountTeacher")
                        .HasForeignKey("IUniversity.Common.Entities.Teacher", "TeacherAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
